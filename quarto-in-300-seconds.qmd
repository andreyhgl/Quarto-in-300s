...
format:
  revealjs:
    ...
    smaller: true
    css: custom.css
    footer: "[Github repo](https://github.com/andreyhgl/Quarto-in-300s) | [Quarto](https://quarto.org/) in 300 Seconds"
author: 
  - name: "Andrey Höglund"
...
![](images/quarto_logo.png){height=300 style="position: absolute; top: 60px; right: 250px; filter: drop-shadow(3px 3px 5px rgba(0,0,0,0.7));"}
