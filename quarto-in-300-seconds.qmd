...
::: {.fragment style="position: absolute; top: 100px; right: 0px; width: 60%;"}
...
````{.md filename="script.py" code-line-numbers="|1|3"}
```{{python}}
# Air particle measurements in a vector
measurements = [10, 15, 20, 33, 50, 32, 49, 18, 30, 54, 23]
len(measurements)
sum(measurements)
```
````
...
````{.md filename="script.py" code-line-numbers="4"}
```{{python}}
# Air particle measurements in a vector
measurements = [10, 15, 20, 33, 50, 32, 49, 18, 30, 54, 23]
len(measurements)
...
````{.md filename="script.py" code-line-numbers="5"}
```{{python}}
# Air particle measurements in a vector
measurements = [10, 15, 20, 33, 50, 32, 49, 18, 30, 54, 23]
len(measurements)
...
## _Research Trends in Toxicology_ (MI8016)

[![](images/homepage.png)]{.fragment}
